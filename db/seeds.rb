...
#   Character.create(name: 'Luke', movie: movies.first)
  ...
  user1 = User.create(username: "FoodieJim1", password: "password1")
  user2 = User.create(username: "TacoLover2", password: "password2")
  user3 = User.create(username: "Jenn3", password: "password3")
  user4 = User.create(username: "MarcoLovesFood4", password: "password4")
  user5 = User.create(username: "Live4Food5", password: "password5")
